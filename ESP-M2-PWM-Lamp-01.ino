...
void setTopics() {
//  ledTopic = topicPrefix + "light/" + devLocation + "/" + devName;
//  ledSetSubTopic = ledTopic + "/set"; //Reads this address for light commands
//  ledStatePubTopic = ledTopic + "/state"; //Sends to this address when led has switched
//  ledConfigPubTopic = ledTopic + "/led/config"; //Sends autodiscovery data to this address
//  buttonTopic = topicPrefix + "switch/" + devLocation + "/" + devName;
//  buttonSetPubTopic = buttonTopic + "/set"; //Sends to this address when button pressed
//  buttonConfigPubTopic = buttonTopic + "button/config"; //Sends autodiscovery data to this address
//  //Revise these below
//  const char subTopic[] = "homeassistant/switch/kitchenESP/set";
...
//  json["command_on_template"] = {"state": "ON", "brightness": {{ brightness }}};
//  json["command_off_template"] = "OFF";
//  json["brightness_template"] = "{{ value_json.brightness }}"; 
//  json["state_template"] = "{{ value_json.state }}"; 

// optional topics to add to JSON (keep in mind there is a character limit to JSON transmission)
